...
export const LOCATIONS: Location[] = [
  { id: 'paje', name: 'Paje', slug: 'paje', description: 'Premium treated timber delivery to Paje beach and resort area — the heart of Zanzibar\'s east coast tourism', uniqueContent: 'Paje is Zanzibar\'s most vibrant east coast beach destination, known for its white sand beaches, kite surfing, and eco-luxury resorts. Construction in Paje ranges from beachfront boutique hotels to private villas, all requiring timber that can withstand the strong sea breezes and high humidity of the Indian Ocean coast.' },
  { id: 'nungwi', name: 'Nungwi', slug: 'nungwi', description: 'Treated timber for Nungwi hotels and resorts — Zanzibar\'s premier beach destination at the northern tip', uniqueContent: 'Nungwi sits at the northernmost tip of Zanzibar and is home to some of the island\'s most prestigious beachfront resorts. The area experiences strong trade winds and salt spray, making treated pine timber the ideal choice for hotel construction, decking, and outdoor structures that need to endure the coastal environment.' },
  { id: 'kendwa', name: 'Kendwa', slug: 'kendwa', description: 'Quality treated timber for Kendwa luxury developments and beachfront villas on the north-west coast', uniqueContent: 'Kendwa is renowned for its luxury villa developments and high-end residential communities on Zanzibar\'s north-west coast. Unlike many other areas, Kendwa\'s beach is not affected by tides, making it a prime location for permanent beachfront structures that require durable, treated timber for long-lasting performance.' },
  { id: 'kiwengwa', name: 'Kiwengwa', slug: 'kiwengwa', description: 'Treated timber for Kiwengwa beach properties and resort construction on Zanzibar\'s north-east coast', uniqueContent: 'Kiwengwa is one of the fastest-growing tourism areas on Zanzibar\'s north-east coast, with numerous new hotels and resorts under construction. The area\'s development boom has created high demand for construction timber, with 2x4 and 2x6 being the most sought-after sizes for framing and structural work.' },
  { id: 'matemwe', name: 'Matemwe', slug: 'matemwe', description: 'Treated timber supply Matemwe North East Zanzibar for resorts, villas and residential projects', uniqueContent: 'Matemwe offers a quieter alternative to the more developed beach areas, with a mix of boutique resorts and community-focused construction projects. The coral rock landscape of Matemwe requires careful foundation work, and our treated pine timber is frequently used for elevated decking and structures that adapt to the terrain.' },
  { id: 'jambiani', name: 'Jambiani', slug: 'jambiani', description: 'Treated timber for Jambiani beachfront projects and community construction on the south-east coast', uniqueContent: 'Jambiani stretches along Zanzibar\'s south-east coast and is known for its traditional fishing villages transitioning into tourism destinations. Construction in Jambiani often involves a mix of modern and traditional Swahili architecture, where treated pine timber provides the structural integrity needed for contemporary builds.' },
  { id: 'stone-town', name: 'Stone Town', slug: 'stone-town', description: 'Historical restoration with treated timber — supplying Stone Town\'s heritage buildings and urban projects', uniqueContent: 'Stone Town is a UNESCO World Heritage site with unique architectural requirements. Restoration and renovation projects in the historic district require timber that matches traditional specifications while meeting modern durability standards. Our treated pine is used for structural reinforcement, joinery, and restoration work throughout the old town.' },
  { id: 'fumba', name: 'Fumba', slug: 'fumba', description: 'Treated timber for Fumba peninsula development and new construction projects in south-west Zanzibar', uniqueContent: 'Fumba is Zanzibar\'s newest development frontier, with the Fumba Town master-planned community driving significant construction activity. This rapidly growing area requires reliable timber supply for everything from residential homes to commercial buildings, with bulk delivery being the preferred option for most developers.' },
  { id: 'chwaka', name: 'Chwaka', slug: 'chwaka', description: 'Treated timber delivery for Chwaka area and surrounding coastal development projects', uniqueContent: 'Chwaka is a growing coastal community on Zanzibar\'s east coast, situated within a scenic bay area. Construction in Chwaka ranges from residential homes to small tourism developments, all benefiting from our reliable timber delivery service and competitive pricing.' },
  { id: 'bwejuu', name: 'Bwejuu', slug: 'bwejuu', description: 'Treated timber supply for Bwejuu beach area and east coast construction projects', uniqueContent: 'Bwejuu is one of the original beach destinations on Zanzibar\'s east coast, known for its laid-back atmosphere and beachfront properties. The area sees steady construction activity for both residential and tourism-related projects, with treated pine being the preferred material for its resistance to the coastal climate.' },
  { id: 'michamvi', name: 'Michamvi', slug: 'michamvi', description: 'Timber delivery for Michamvi and the north-east peninsula development area', uniqueContent: 'Michamvi sits on a peninsula along Zanzibar\'s east coast, offering stunning ocean views and a growing number of resort developments. The unique geography of Michamvi creates microclimate conditions that require carefully selected construction materials, and our treated pine timber is well-suited to the area\'s specific environmental demands.' },
  { id: 'kizimkazi', name: 'Kizimkazi', slug: 'kizimkazi', description: 'Treated timber for Kizimkazi fishing village and south coast construction projects', uniqueContent: 'Kizimkazi is famous for dolphin tours and traditional fishing culture on Zanzibar\'s south coast. Construction here typically involves a mix of tourism infrastructure and community buildings, with treated pine timber providing the durability needed in this exposed southern location.' },
  { id: 'makunduchi', name: 'Makunduchi', slug: 'makunduchi', description: 'Timber delivery for Makunduchi and the south-east tip of Zanzibar', uniqueContent: 'Makunduchi marks the south-eastern tip of Zanzibar and is known for its traditional Mwaka Kogwa festival and quiet beach atmosphere. Development here is more modest compared to the north and east coasts, but reliable timber delivery is still essential for local construction and renovation projects.' },
  { id: 'chukwani', name: 'Chukwani', slug: 'chukwani', description: 'Treated timber supply for Chukwani area and surrounding residential developments', uniqueContent: 'Chukwani is a rapidly developing residential area located just south of Zanzibar City, making it a convenient location for homeowners and small-scale developers. The area\'s proximity to the main road network ensures quick delivery turnaround, and many of our residential customers in Chukwani appreciate our cash-on-delivery payment option for their construction projects.' },
  { id: 'bububu', name: 'Bububu', slug: 'bububu', description: 'Treated timber delivery for Bububu and the north-west coastal strip development corridor', uniqueContent: 'Bububu is one of the fastest-growing residential and tourism corridors on Zanzibar\'s north-west coast, stretching from Zanzibar City towards the northern beaches. The area has seen a construction boom with new hotels, villas, and residential developments all requiring reliable timber supply with efficient delivery logistics.' },
  { id: 'ndevu', name: 'Ndevu', slug: 'ndevu', description: 'Kwa Ndevu, Daraja Bovu — our main timber yard location and central Zanzibar distribution hub', uniqueContent: 'Kwa Ndevu, Daraja Bovu is home to our main timber yard and distribution centre. Located in central Zanzibar, this strategic position allows us to serve customers across the entire island efficiently. Customers are welcome to visit our yard to inspect timber quality, discuss project requirements, and arrange bulk orders directly with our team.' },
]
