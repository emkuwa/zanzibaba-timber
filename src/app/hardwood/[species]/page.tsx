        ...
        <div className="container-custom">
          ...
          <div className="grid lg:grid-cols-2 gap-10 mb-14">
            ...
            <div>
              ...
              <a href={generateWhatsAppLink(`Hello Zanzibaba Timber, I need a quote for ${product.name} hardwood`)} target="_blank" rel="noopener noreferrer" className="inline-block bg-green-600 hover:bg-green-700 text-white font-bold px-7 py-3 rounded-lg">Request on WhatsApp</a>
            </div>
          </div>
