...
const seoFAQ = [
  ...
  { question: 'How much does marine board cost in Zanzibar?', answer: 'Marine board prices at Zanzibaba Timber: 18mm at 52,000 and 12mm at 46,000 per sheet. Prices include transport. Prices exclude VAT. Contact us for bulk order discounts and delivery scheduling.' },
        ...
        <section className="py-10 md:py-16 bg-white dark:bg-gray-900">
          <div className="container-custom">
            ...
            <h1 className="text-3xl md:text-5xl font-bold text-center mb-4">
              Marine Board <span className="text-primary-600">Zanzibar</span> — Waterproof Plywood Supplier
            </h1>
