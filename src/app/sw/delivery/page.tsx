...
export const metadata = generateSEOMetadata(
  'Usafiri Bure Mbao Zanzibar — Malipo Baada ya Kupelekwa',
  'Usafiri bure wa mbao kote Zanzibar — Paje, Nungwi, Kendwa, Stone Town, Jambiani, Matemwe, Kiwengwa, Fumba, Chukwani, Bububu. Malipo baada ya kupelekwa. Saa 24-48. Piga +255 716 002 790.',
  'sw',
  '/sw/delivery'
)
        ...
        <section className="py-20 bg-white dark:bg-gray-900">
          <div className="container-custom">
            <nav className="mb-4 md:mb-6 text-sm" aria-label="Breadcrumb">
              ...
              <span className="text-gray-500">Usafiri</span>
            </nav>
            <h1 className="text-4xl md:text-5xl font-bold text-center mb-6">Usafiri Bure Mbao, Mirunda na Vifaa vya Ujenzi Zanzibar</h1>
            <p className="text-lg text-center text-gray-600 dark:text-gray-300 mb-12 max-w-3xl mx-auto">
              Usafiri bure kwa maagizo yote Zanzibar zima. Tunawasilisha mbao, mirunda, marine board, plywood, na vifaa vya ujenzi kote kisiwani kwa haraka na uhakika. Malipo baada ya kupelekwa yanakubalika. Saa 24-48 kwa bidhaa za kawaida. Pata bei leo — agiza kupitia WhatsApp.
            </p>

            <div className="grid md:grid-cols-2 gap-8 mb-12">
              <div className="bg-gray-50 dark:bg-gray-800 p-8 rounded-lg">
                <h2 className="text-2xl font-bold mb-4">Maeneo Tunayosafirishia</h2>
                <p className="text-gray-600 dark:text-gray-300 mb-4">Tunasafirishia kote Zanzibar:</p>
              ...
              <div className="bg-gray-50 dark:bg-gray-800 p-8 rounded-lg">
                <h2 className="text-2xl font-bold mb-4">Huduma za Usafiri</h2>
                <ul className="space-y-3 text-gray-600 dark:text-gray-300">
                  <li><strong>Usafiri Bure:</strong> Tunatoa usafiri bure kwa maagizo yote Zanzibar zima</li>
                  <li><strong>Kasi:</strong> Usafiri ndani ya saa 24-48 kwa bidhaa za kawaida</li>
            ...
            <div className="text-center">
              <p className="text-lg mb-4">Panga usafiri wako leo</p>
