        ...
        <section className="py-8 md:py-16 bg-white dark:bg-gray-900">
          <div className="container-custom">
            ...
            <p className="text-center text-gray-600 dark:text-gray-300 mb-8 max-w-3xl mx-auto text-sm md:text-base">
              High-quality construction plywood in all standard thicknesses. From structural 18mm to lightweight 3mm — perfect for every building project in Zanzibar.
            </p>
              ...
              {plywoodProducts.map((product) => (
                ...
                >
                  ...
                  <div className="p-4">
                    ...
                    <div className="text-xs text-gray-400 mb-2">per sheet (4ft x 8ft)</div>
            ...
            <div className="max-w-5xl mx-auto mb-12">
              <h2 className="text-2xl font-bold mb-6">Plywood Thickness Guide for Zanzibar</h2>
              <div className="overflow-x-auto">
                <table className="w-full border-collapse">
                  <thead>
                    <tr className="border-b-2 border-primary-600">
                      <th className="text-left py-3 px-3 text-sm">Thickness</th>
                      <th className="text-left py-3 px-3 text-sm">Best For</th>
                  ...
                  <tbody>
                    {plywoodProducts.map((product) => (
                      <tr key={product.id} className="border-b border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800">
                        ...
                        <td className="py-3 px-3 text-sm text-gray-600 dark:text-gray-300">{product.suitableProjects[0]}</td>
            ...
            <div className="max-w-5xl mx-auto mb-12 bg-gray-50 dark:bg-gray-800 rounded-xl p-6 md:p-8">
              <h2 className="text-2xl font-bold mb-4">Why Choose Plywood from Zanzibaba Timber?</h2>
              <div className="grid md:grid-cols-3 gap-4">
                {[
                  { icon: Layers, title: 'All Thicknesses', desc: 'We stock 3mm through 18mm plywood. Whatever your project needs, we have the right thickness in stock.' },
                  { icon: Shield, title: 'Construction Grade', desc: 'All our plywood is sourced from reputable manufacturers and meets construction industry standards for strength and durability.' },
                  { icon: Truck, title: 'Island-Wide Delivery', desc: 'We deliver plywood sheets to every location in Zanzibar. From Stone Town to Paje, Nungwi to Kendwa — we cover the entire island.' },
                ].map((item) => (
            ...
            <div className="max-w-5xl mx-auto mb-12">
              <h2 className="text-2xl font-bold mb-4">We Deliver Plywood Across Zanzibar</h2>
              <p className="text-gray-600 dark:text-gray-300 mb-4 text-sm">
                We deliver construction timber products including plywood and marine board across all Zanzibar. Cash on delivery available. 24-48 hour delivery for stock items.
              </p>
