...
export default function MarineBoardProductPage({ params }: { params: { thickness: string } }) {
  const product = SHEET_PRODUCTS.find(p => p.categoryId === 'marine-board' && p.slug === params.thickness)
  if (!product) notFound()
          ...
          <div className="container-custom px-3 md:px-4">
            <div className="relative w-full h-48 sm:h-56 md:h-72 rounded-lg md:rounded-xl overflow-hidden mb-6 md:mb-8 shadow-lg">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-3 md:p-6">
                ...
                <p className="text-gray-200 mt-1 text-xs sm:text-sm">Waterproof Marine Board — {product.thickness} — {product.sheetSize}</p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-5 gap-6 md:gap-8">
              <div className="md:col-span-3">
                ...
                <div className="mb-6">
                  <h3 className="font-semibold text-base mb-3 flex items-center gap-2">
                    <Droplets className="w-5 h-5 text-blue-500" /> Moisture Resistance
                  </h3>
            ...
            <div className="mt-6 md:mt-10 border-t pt-4 md:pt-6">
              <div className="flex flex-wrap justify-center gap-2 md:gap-4 text-xs md:text-sm">
                <Link href="/marine-board" className="text-primary-600 hover:underline">← All Marine Board</Link>
