...
export default function SearchPage({ searchParams }: { searchParams: { q?: string } }) {
  ...
  return <><Header /><main className="py-12 md:py-20 bg-gray-50 dark:bg-gray-900 min-h-[60vh]"><div className="container-custom max-w-4xl">
    ...
    {softwoodResults.length > 0 && <section className="mb-12"><div className="flex items-end justify-between mb-5"><div><p className="text-xs uppercase tracking-widest font-bold text-primary-600">Category</p><h2 className="text-3xl font-bold">Softwood</h2></div><Link href="/timber-sizes" className="text-primary-600 font-semibold hover:underline">View all softwood →</Link></div><ResultList results={softwoodResults} /></section>}
