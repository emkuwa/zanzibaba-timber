...
const seoFAQ = [
  ...
  { question: 'How much does plywood cost in Zanzibar?', answer: 'Plywood prices in Zanzibar at Zanzibaba Timber: 18mm at TZS 50,000, 15mm at TZS 46,000, 12mm at TZS 43,000, 9mm at TZS 40,000, 6mm at TZS 28,000, and 3mm at TZS 18,000 per sheet. All prices include transport. Prices exclude VAT.' },
  ...
  { question: 'Can I get plywood delivered to my site in Zanzibar?', answer: 'Yes, Zanzibaba Timber delivers plywood and all construction timber products to every location across Zanzibar. We cover Stone Town, Paje, Nungwi, Kendwa, Jambiani, Matemwe, Kiwengwa, Fumba, and all other areas. Cash on delivery is available.' },
        ...
        <section className="py-10 md:py-16 bg-white dark:bg-gray-900">
          <div className="container-custom">
            ...
            <p className="text-center text-gray-600 dark:text-gray-300 mb-8 max-w-3xl mx-auto text-sm md:text-base">
              Zanzibaba Timber is Zanzibar&apos;s trusted supplier of construction plywood. We stock all standard thicknesses from 3mm to 18mm in 4ft x 8ft sheets. From structural flooring to decorative paneling — we have the right plywood for every project.
            </p>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-300 mb-4">
                    Thicker plywood grades for load-bearing applications. Ideal for flooring, roofing, concrete formwork, and heavy-duty construction in Zanzibar.
                  </p>
